...
import { FaTicketAlt, FaCalendarAlt, FaMoneyBillWave, FaHistory, FaBell } from 'react-icons/fa';
        ...
        {upcomingEvents.map(event => (
          <div key={event.id} className={styles.eventCard}>
            <div className={styles.eventInfo}>
              <h4>{event.name}</h4>
              <p><FaCalendarAlt /> {event.date} • {event.venue}</p>
              <p><FaTicketAlt /> {event.ticketType} Ticket</p>
                ...
                <div className={styles.installmentInfo}>
                  <div className={styles.progressBar}>
                    <div
                      ...
                      style={{ width: `${(event.payment.paid / event.payment.amount) * 100}%` }}
                    ></div>
                  </div>
